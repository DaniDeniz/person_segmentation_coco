...
def Unet_mini_reduced(nClasses, input_height=256, input_width=256, nChannels=3):
    inputs = Input(shape=(input_height, input_width, nChannels))
    # encode
    # 224x224
    conv1 = Conv2D(64, (3, 3), padding='same', activation="relu", kernel_initializer=orthogonal())(inputs)
    ...
    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3)
    # 28x28
    conv4 = Conv2D(256, (3, 3), padding='same', activation="relu", kernel_initializer=orthogonal())(pool3)
    conv4 = SpatialDropout2D(0.2)(conv4)
    conv4 = Conv2D(256, (3, 3), padding='same', activation="relu", kernel_initializer=orthogonal())(conv4)
